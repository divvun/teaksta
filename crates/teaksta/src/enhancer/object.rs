...
impl Default for Vislcg3ObjectEnhancer {
    fn default() -> Self {
...
impl Vislcg3ObjectEnhancer {
    ...
    pub fn process(&self, doc: &mut Document) -> Result<()> {
        info!("Starting Object enhancement");
                ...
                for i in 0..reading_count {
                    ...
                    if matches {
                        ...
                        let span_start_tag = format!(
                            "<span id=\"{}\" class=\"wertiviewtoken  wertiviewObject \">",
        ...
        info!("Finished Object enhancement");
        Ok(())
    }
