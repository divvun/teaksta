 ...
 *
 */
public class Vislcg3NounsAllEnhancer extends JCasAnnotator_ImplBase {

	private static final Logger log =
		Logger.getLogger(Vislcg3NounsAllEnhancer.class);
	...
	*/
	...
	public void process(JCas cas) throws AnalysisEngineProcessException {
		log.info("Starting Noun enhancement");
		...
		for (String conT: NTags) {
			...
			while (cgTokenIter.hasNext()) {
				...
				if (containsTag(reading, conT, enhancement_type)) {
					...
					String spanStartTag = "<span id=\"" + EnhancerUtils.get_id("WERTi-span-" + conT, newId) + "\" class=\"wertiviewtoken  wertiviewNounsAll \" lemma=\"" + lemma + "\" distractors=\"" + distractors + "\">";
		...
		log.info("Finished N enhancement");
	}
