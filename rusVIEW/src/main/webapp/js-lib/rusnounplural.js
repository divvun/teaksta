	...
	remove: function(contextDoc) {
		...
		$('body').undelegate('span.wertiviewtoken', 'click', wertiview.rusnounplural.clickHandler);
		$('body').undelegate('select.wertiviewinput', 'change', wertiview.rusnounplural.clozeInputHandler);
		$('body').undelegate('span.wertiviewhint', 'click', wertiview.rusnounplural.clozeHintHandler);
		$('body').undelegate('input.wertiviewinput', 'change', wertiview.rusnounplural.clozeInputHandler);
		$('body').undelegate('input.wertiviewhint', 'click', wertiview.rusnounplural.clozeHintHandler);  // was: span.wertiviewhint
...
span.find('span.wertiviewhit').addClass('colorizeStyleRusNounPlural');
	...
	click: function(contextDoc) {
		...
		// handle click
		$('body').delegate('span.wertiviewtoken', 'click', {context: contextDoc}, wertiview.rusnounplural.clickHandler); 
	},
	...
	mcGetOptions: function($hit, capType){
        ...
        while (j < wertiview.rusnounplural.types.length && options.length < wertiview.rusnounplural.MAX_MC - 1) {
            ...
            if (wertiview.rusnounplural.types[j].toLowerCase() != $hit.text().toLowerCase() && wertiview.rusnounplural.types[j] != "") 
            {
