	...
	remove: function(contextDoc) {
		...
		$('body').undelegate('span.wertiviewtoken', 'click', wertiview.rusadjectiveneutral.clickHandler);
		$('body').undelegate('select.wertiviewinput', 'change', wertiview.rusadjectiveneutral.clozeInputHandler);
		$('body').undelegate('span.wertiviewhint', 'click', wertiview.rusadjectiveneutral.clozeHintHandler);
		$('body').undelegate('input.wertiviewinput', 'change', wertiview.rusadjectiveneutral.clozeInputHandler);
		$('body').undelegate('input.wertiviewhint', 'click', wertiview.rusadjectiveneutral.clozeHintHandler);  // was: span.wertiviewhint
...
span.find('span.wertiviewhit').addClass('colorizeStyleRusAdjectiveNeutral');
	...
	click: function(contextDoc) {
		...
		// handle click
		$('body').delegate('span.wertiviewtoken', 'click', {context: contextDoc}, wertiview.rusadjectiveneutral.clickHandler); 
	},
	...
	mcGetOptions: function($hit, capType){
        ...
        while (j < wertiview.rusadjectiveneutral.types.length && options.length < wertiview.rusadjectiveneutral.MAX_MC - 1) {
            ...
            if (wertiview.rusadjectiveneutral.types[j].toLowerCase() != $hit.text().toLowerCase() && wertiview.rusadjectiveneutral.types[j] != "") 
            {
