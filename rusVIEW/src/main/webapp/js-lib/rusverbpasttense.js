	...
	remove: function(contextDoc) {
		...
		$('body').undelegate('span.wertiviewtoken', 'click', wertiview.rusverbpasttense.clickHandler);
		$('body').undelegate('select.wertiviewinput', 'change', wertiview.rusverbpasttense.clozeInputHandler);
		$('body').undelegate('span.wertiviewhint', 'click', wertiview.rusverbpasttense.clozeHintHandler);
		$('body').undelegate('input.wertiviewinput', 'change', wertiview.rusverbpasttense.clozeInputHandler);
		$('body').undelegate('input.wertiviewhint', 'click', wertiview.rusverbpasttense.clozeHintHandler);  // was: span.wertiviewhint
...
span.find('span.wertiviewhit').addClass('colorizeStyleRusVerbPastTense');
	...
	click: function(contextDoc) {
		...
		// handle click
		$('body').delegate('span.wertiviewtoken', 'click', {context: contextDoc}, wertiview.rusverbpasttense.clickHandler); 
	},
	...
	mcGetOptions: function($hit, capType){
        ...
        while (j < wertiview.rusverbpasttense.types.length && options.length < wertiview.rusverbpasttense.MAX_MC - 1) {
            ...
            if (wertiview.rusverbpasttense.types[j].toLowerCase() != $hit.text().toLowerCase() && wertiview.rusverbpasttense.types[j] != "") 
            {
