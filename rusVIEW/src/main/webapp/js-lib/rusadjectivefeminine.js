	...
	remove: function(contextDoc) {
		...
		$('body').undelegate('span.wertiviewtoken', 'click', wertiview.rusadjectivefeminine.clickHandler);
		$('body').undelegate('select.wertiviewinput', 'change', wertiview.rusadjectivefeminine.clozeInputHandler);
		$('body').undelegate('span.wertiviewhint', 'click', wertiview.rusadjectivefeminine.clozeHintHandler);
		$('body').undelegate('input.wertiviewinput', 'change', wertiview.rusadjectivefeminine.clozeInputHandler);
		$('body').undelegate('input.wertiviewhint', 'click', wertiview.rusadjectivefeminine.clozeHintHandler);  // was: span.wertiviewhint
...
span.find('span.wertiviewhit').addClass('colorizeStyleRusAdjectiveFeminine');
	...
	click: function(contextDoc) {
		...
		// handle click
		$('body').delegate('span.wertiviewtoken', 'click', {context: contextDoc}, wertiview.rusadjectivefeminine.clickHandler); 
	},
	...
	mcGetOptions: function($hit, capType){
        ...
        while (j < wertiview.rusadjectivefeminine.types.length && options.length < wertiview.rusadjectivefeminine.MAX_MC - 1) {
            ...
            if (wertiview.rusadjectivefeminine.types[j].toLowerCase() != $hit.text().toLowerCase() && wertiview.rusadjectivefeminine.types[j] != "") 
            {
