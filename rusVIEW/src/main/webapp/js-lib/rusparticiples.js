	...
	remove: function(contextDoc) {
		...
		$('body').undelegate('span.wertiviewtoken', 'click', wertiview.rusparticiples.clickHandler);
		$('body').undelegate('select.wertiviewinput', 'change', wertiview.rusparticiples.clozeInputHandler);
		$('body').undelegate('span.wertiviewhint', 'click', wertiview.rusparticiples.clozeHintHandler);
		$('body').undelegate('input.wertiviewinput', 'change', wertiview.rusparticiples.clozeInputHandler);
		$('body').undelegate('input.wertiviewhint', 'click', wertiview.rusparticiples.clozeHintHandler);  // was: span.wertiviewhint
...
span.find('span.wertiviewhit').addClass('colorizeStyleRusParticiples');
	...
	click: function(contextDoc) {
		...
		// handle click
		$('body').delegate('span.wertiviewtoken', 'click', {context: contextDoc}, wertiview.rusparticiples.clickHandler); 
	},
	...
	mcGetOptions: function($hit, capType){
        ...
        while (j < wertiview.rusparticiples.types.length && options.length < wertiview.rusparticiples.MAX_MC - 1) {
            ...
            if (wertiview.rusparticiples.types[j].toLowerCase() != $hit.text().toLowerCase() && wertiview.rusparticiples.types[j] != "") 
            {
