	wertiview.verbconjugation = {
	  ...
	  remove: function(contextDoc) {
	    ...
	    var $ = function(selector, context) {
	      return new jQuery.fn.init(selector, contextDoc || window.document);
	    };
	    $.fn = $.prototype = jQuery.fn;

	    $('body').undelegate('span.wertiviewtoken', 'click', wertiview.verbconjugation.clickHandler);
	    $('body').undelegate('select.wertiviewinput', 'change', wertiview.verbconjugation.clozeInputHandler);
	    $('body').undelegate('span.wertiviewhint', 'click', wertiview.verbconjugation.clozeHintHandler);
	    $('body').undelegate('input.wertiviewinput', 'change', wertiview.verbconjugation.clozeInputHandler);
	    $('body').undelegate('input.wertiviewhint', 'click', wertiview.verbconjugation.clozeHintHandler); // was: span.wertiviewhint
	  ...
	  click: function(contextDoc) {
	    ...
	    // handle click
	    $('body').delegate('span.wertiviewtoken', 'click', {
	      context: contextDoc
	    }, wertiview.verbconjugation.clickHandler);
	  },
	  ...
	  mc: function(contextDoc) {
	    ...
	    wertiview.activity.mc(contextDoc, wertiview.verbconjugation.hitList,
	      ...
	      wertiview.verbconjugation.clozeHintHandler,
	      wertiview.verbconjugation.mcGetOptions,
	      wertiview.verbconjugation.mcGetCorrectAnswer);
	  ...
	  cloze: function(contextDoc) {
	    ...
	    wertiview.activity.cloze(contextDoc, hitList,
	      wertiview.verbconjugation.clozeInputHandler,
	      wertiview.verbconjugation.clozeHintHandler,
	      wertiview.verbconjugation.clozeGetCorrectAnswer,
	      wertiview.verbconjugation.clozeAddBaseform);
	  },
